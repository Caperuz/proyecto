    ...
    function Travel() {
        ...
        return (
            <React.Fragment>
                ...
                { window.location.pathname === '/' ? cardapi.data && cardapi.data.allCards.map ( RenderMap => <Card key={RenderMap.id} id={RenderMap.id} price={RenderMap.price} imgUrl={RenderMap.imgUrl} link={RenderMap.link} scale={RenderMap.scale} stayId={RenderMap.stayId} description={RenderMap.description} /> ) : '' }
